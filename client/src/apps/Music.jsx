...
export function Music({ winId, appState = {}, updateAppState }) {
  ...
  return (
    /* Changed height from 100vh to 100% to live perfectly inside parent containers */
    <div className="music-shell" style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", backgroundColor: "#000", color: "#fff", fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif', overflow: "hidden" }}>
      ...
      <style>{`
        ...
        /* Custom scrollbar to keep it sleek and minimal */
      ...
      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", flex: 1, minHeight: 0, padding: "8px 8px 0 8px", gap: 8, overflow: "hidden" }}>
        
        {/* Left Side Navigation Panel */}
        <aside style={{ background: "#121212", borderRadius: 8, padding: "20px 16px", display: "flex", flexDirection: "column", gap: 24, minHeight: 0 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingBottom: 12, minHeight: 0 }}>
        ...
        <section style={{ background: "linear-gradient(180deg, #1e1e1e 0%, #121212 30%)", borderRadius: 8, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden" }}>
          <div className="custom-scroll" style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column" }}>
            ...
            {/* Header Banner view */}
            <div style={{ padding: "40px 32px 24px 32px", display: "flex", alignItems: "flex-end", gap: 24, background: "linear-gradient(transparent, rgba(0,0,0,0.3))", flexShrink: 0 }}>
              <div style={{ width: 192, height: 192, background: "linear-gradient(135deg, #450e4b 0%, #1e2056 100%)", borderRadius: 4, boxShadow: "0 8px 24px rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div style={{ padding: "24px 32px", display: "flex", alignItems: "center", gap: 32, flexShrink: 0 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {queue.map((track, trackIndex) => {
                  ...
                  return (
                    ...
                    >
                      <div style={{ fontSize: 15, color: active ? "#1ed760" : "#b3b3b3" }}>
                        <span className="track-index" style={{ display: "block" }}>
                          {active && playing ? "█║" : trackIndex + 1}
                        </span>
      ...
      {/* Persistent Bottom Bar Dock Controls */}
      <footer style={{ height: 90, background: "#181818", borderTop: "1px solid #282828", display: "grid", gridTemplateColumns: "1fr 2fr 1fr", alignItems: "center", padding: "0 16px", zIndex: 10, flexShrink: 0 }}>
